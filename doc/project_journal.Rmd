...
Resized map images in powerpoint output. Added additional code to make sure all building permits have a "new use". This may be something that will need constant updating based on what permits are in each month. Removed old knitr code. 
