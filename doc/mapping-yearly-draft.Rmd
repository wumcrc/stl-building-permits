...
merge_sf %>%
  filter(Nbrhd == 39) %>%
  smooth_map(., bandwidth = 0.2, style = "pretty",
...
tmap_save(cwe_den_tm, file = here("results", params$year, "yearly", "cwe", "cwe_density.jpeg"), width = 9, height = 5, units = "in")

#add to powerpoint report
report%>%
  add_slide()%>%
  ph_with(external_img(here::here("results", params$year, "yearly", "cwe", "cwe_density.jpeg"), width = 9, height = 5), location = ph_location_type(type="body"), use_loc_size = FALSE)%>%
  ph_with("Central West End: Building Permit Density Map", 
               location = ph_location_type(
                 type = "title") )-> report
```
...
tmap_save(dbp_den_tm, file = here("results", params$year, "yearly", "dbplace", "dbp_density.jpeg"), width = 9, height = 5, units = "in")

#add to powerpoint report
report%>%
  add_slide()%>%
  ph_with(external_img(here::here("results", params$year, "yearly", "dbplace", "dbp_density.jpeg"), width = 9, height = 5), location = ph_location_type(type = "body"), use_loc_size = FALSE)%>%
...
tmap_save(sdb_den_tm, file = here("results", params$year, "yearly", "skinker", "sdb_density.jpeg"), width = 9, height = 5, units = "in")

#add to powerpoint report
report%>%
  add_slide()%>%
  ph_with(external_img(here::here("results", params$year, "yearly", "skinker", "sdb_density.jpeg"), width = 9, height = 5), location = ph_location_type(type = "body"), use_loc_size = FALSE)%>%
...
tmap_save(we_den_tm, file = here("results", params$year, "yearly", "westend", "we_density.jpeg"), width = 9, height = 5, units = "in")

#add to powerpoint report
report%>%
  add_slide()%>%
  ph_with(external_img(here::here("results", params$year, "yearly", "westend", "we_density.jpeg"), width = 9, height = 5), location = ph_location_type(type = "body"), use_loc_size = FALSE)%>%
  ph_with("West End: Building Permit Density", 
               location = ph_location_type(
                 type = "title") )-> report
```
...
```{r VP Density Map Prep, include = FALSE}
merge_sf %>%
  filter(Nbrhd == 49) %>%
  smooth_map(., bandwidth = 0.1, style = "pretty",
  cover = vp) -> vp_densities

vp_den_tm <- tm_shape(vp_tiles) +
  tm_rgb() +
  nhoods_sf %>%
...
tmap_save(we_den_tm, file = here("results", params$year, "yearly", "vstprk", "vp_density.jpeg"), width = 9, height = 5, units = "in")

#add to powerpoint report
report%>%
  add_slide()%>%
  ph_with(external_img(here::here("results", params$year, "yearly", "vstprk", "vp_density.jpeg"), width = 9, height = 5), location = ph_location_type(type = "body"), use_loc_size = FALSE)%>%
  ph_with("Visitation Park: Building Permit Density", 
               location = ph_location_type(
                 type = "title") )-> report
```
...
tmap_save(ac_den_tm, file = here("results", params$year, "yearly", "academy", "ac_density.jpeg"), width = 9, height = 5, units = "in")

#add to powerpoint report
report%>%
  add_slide()%>%
  ph_with(external_img(here::here("results", params$year, "yearly", "academy", "ac_density.jpeg"), width = 9, height = 5), location = ph_location_type(type = "body"), use_loc_size = FALSE)%>%
  ph_with("Academy: Building Permit Density Map", 
               location = ph_location_type(
                 type = "title") )-> report
```
...
tmap_save(fp_den_tm, file = here("results", params$year, "yearly", "ftnprk", "fp_density.jpeg"), width = 9, height = 5, units = "in")

report%>%
  add_slide()%>%
  ph_with(external_img(here::here("results", params$year, "yearly", "ftnprk", "fp_density.jpeg"), width = 9, height = 5), location = ph_location_type(type = "body"), use_loc_size = FALSE)%>%
  ph_with("Fountain Park: Building Permit Density Map", 
               location = ph_location_type(
                 type = "title") )-> report
```
...
tmap_save(lp_den_tm, file = here("results", params$year, "yearly", "lewis", "lp_density.jpeg"), width = 9, height = 5, units = "in")

#add to powerpoint report
report%>%
  add_slide()%>%
  ph_with(external_img(here::here("results", params$year, "yearly", "lewis", "lp_density.jpeg"), width = 9, height = 5), location = ph_location_type(type = "body"), use_loc_size = FALSE)%>%
  ph_with("Lewis Place: Building Permit Density Map",
               location = ph_location_type(
                 type = "title") )-> report
```
...
tmap_save(vd_den_tm, file = here("results", params$year, "yearly", "vandy", "vd_density.jpeg"), width = 9, height = 5, units = "in")

#add to powerpoint report
report%>%
  add_slide()%>%
  ph_with(external_img(here::here("results", params$year, "yearly", "vandy", "vd_density.jpeg"), width = 9, height = 5), location = ph_location_type(type = "body"), use_loc_size = FALSE)%>%
  ph_with("Vandeventer: Building Permit Density Map",
               location = ph_location_type(
                 type = "title") )-> report
```
