...
tmap_save(dbp_den_tm, file = here("results", params$year, "yearly", "dbp", "dbp_density.jpeg"), width = 9, height = 5, units = "in")

#add to powerpoint report
report%>%
  add_slide()%>%
  ph_with(external_img(here::here("results", params$year, "yearly", "dbp", "dbp_density.jpeg"), width = 9, height = 5), location = ph_location_type(type = "body"), use_loc_size = FALSE)%>%
...
tmap_save(sdb_den_tm, file = here("results", params$year, "yearly", "sdb", "sdb_density.jpeg"), width = 9, height = 5, units = "in")

#add to powerpoint report
report%>%
  add_slide()%>%
  ph_with(external_img(here::here("results", params$year, "yearly", "sdb", "sdb_density.jpeg"), width = 9, height = 5), location = ph_location_type(type = "body"), use_loc_size = FALSE)%>%
...
tmap_save(we_den_tm, file = here("results", params$year, "yearly", "we", "we_density.jpeg"), width = 9, height = 5, units = "in")

#add to powerpoint report
report%>%
  add_slide()%>%
  ph_with(external_img(here::here("results", params$year, "yearly", "we", "we_density.jpeg"), width = 9, height = 5), location = ph_location_type(type = "body"), use_loc_size = FALSE)%>%
...
tmap_save(we_den_tm, file = here("results", params$year, "yearly", "vp", "vp_density.jpeg"), width = 9, height = 5, units = "in")

#add to powerpoint report
report%>%
  add_slide()%>%
  ph_with(external_img(here::here("results", params$year, "yearly", "vp", "vp_density.jpeg"), width = 9, height = 5), location = ph_location_type(type = "body"), use_loc_size = FALSE)%>%
...
tmap_save(ac_den_tm, file = here("results", params$year, "yearly", "ac", "ac_density.jpeg"), width = 9, height = 5, units = "in")

#add to powerpoint report
report%>%
  add_slide()%>%
  ph_with(external_img(here::here("results", params$year, "yearly", "ac", "ac_density.jpeg"), width = 9, height = 5), location = ph_location_type(type = "body"), use_loc_size = FALSE)%>%
...
tmap_save(fp_den_tm, file = here("results", params$year, "yearly", "fp", "fp_density.jpeg"), width = 9, height = 5, units = "in")

report%>%
  add_slide()%>%
  ph_with(external_img(here::here("results", params$year, "yearly", "fp", "fp_density.jpeg"), width = 9, height = 5), location = ph_location_type(type = "body"), use_loc_size = FALSE)%>%
...
tmap_save(lp_den_tm, file = here("results", params$year, "yearly", "lp", "lp_density.jpeg"), width = 9, height = 5, units = "in")

#add to powerpoint report
report%>%
  add_slide()%>%
  ph_with(external_img(here::here("results", params$year, "yearly", "lp", "lp_density.jpeg"), width = 9, height = 5), location = ph_location_type(type = "body"), use_loc_size = FALSE)%>%
...
tmap_save(vd_den_tm, file = here("results", params$year, "yearly", "vd", "vd_density.jpeg"), width = 9, height = 5, units = "in")

#add to powerpoint report
report%>%
  add_slide()%>%
  ph_with(external_img(here::here("results", params$year, "yearly", "vd", "vd_density.jpeg"), width = 9, height = 5), location = ph_location_type(type = "body"), use_loc_size = FALSE)%>%
