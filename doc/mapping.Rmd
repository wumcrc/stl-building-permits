...
summary <- block_list(
  ...
  fpar(ftext(paste(pct_chg_ytd20, "change ", sep = " "), color24b),
       ftext(paste("compared to this time in ", params$pastyear, " (", bptot19, " total building permits)", sep = ""), reg24)),
  ...
  fpar(ftext(paste(pct_chg_cost20, "change", sep = " "), color20b),
       ftext(paste(" compared to this time in ", params$pastyear, " (", totcost19, ")", sep = ""), reg20))
)
...
print(report, target = here::here("results", "test.pptx"))
```
