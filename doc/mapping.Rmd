...
# st_write(merge, here::here("doc", "nbhd.shp"), 
#          delete_dsn = TRUE)
# library(rgdal)
# library(leaflet)
...
#                     layer = "nbhd",
#                     verbose = FALSE)
# #transform shapefile into lat long dataframe so its compatible w/leaflet
# shapeData <- spTransform(boundary, CRS("+proj=longlat +datum=WGS84 +no_defs"))
# 
# leaflet(shapeData)%>%
#   addPolygons(color = "blue", weight = 1, opacity = 1, fillColor = "blue", fillOpacity = 1, highlightOptions = highlightOptions(color = "white", weight = 1,
#       bringToFront = TRUE), popup = paste())%>%
#   setView(lng = -90.240264, lat = 38.647438, zoom = 13)%>%
