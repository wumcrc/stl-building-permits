...
```{r FPSE ytd summary notes, include=FALSE, eval=FALSE}
...
report%>%
  ...
  ph_with(value = "Introduction", location = ph_location_type(type = "title"))%>%
  ph_with(c(sprint_1, sprint_2, sprint_3, sprint_4 sprint_5, sprint_6, sprint_7, sprint_8), location = ph_location_type(type = "body")) -> report
```
...
#display map
if("West End" %in% df$nbhd_name){
  knitr::include_graphics(here::here("results", params$year, params$month, "westend", "westend_use.jpeg"))
}
```
