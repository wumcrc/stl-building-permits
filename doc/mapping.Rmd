...
# Compiles Year to Date Dataset for this year | Leave at January 1st 2020
  ...
  # Pulls in the data for the most recent month | Change this each month
  date: "2020-03-01"   
  
  # Needs to be the first day of the next month | Change this each month
  enddate: "2020-04-01"
           
  # Compiles Year to Date Dataset for previous year | Leave at January 1st 2019 
  pastdate: "2019-01-01" 
            
  # Compiles Data for the most recent month of the previous year | This is the first day of the month
  pstmonth: "2019-03-01" 
           
  # Compiles Data for the most recent month of the previous year | This is the first day of the next month (of last year)
  pstmonth2: "2019-04-01"  
---
...
report%>%
  add_slide()%>%
  ph_with(external_img(here::here("results", params$year, params$month, "fpse", "fpse_use.jpeg"), width = 9.24, height = 7.47), location = ph_location_type(type = "title"), use_loc_size = FALSE)%>%
...
report%>%
  add_slide()%>%
  ph_with(external_img(here::here("results", params$year, params$month, "cwe", "cwe_use.jpeg"), width = 9.5, height = 7.5), location = ph_location_type(type="title"), use_loc_size = FALSE)%>%
...
report%>%
  add_slide()%>%
  ph_with(external_img(here::here("results", params$year, params$month, "dbplace", "dbplace_use.jpeg"), width = 6.97, height = 7.5), location = ph_location_type(type = "title"), use_loc_size = FALSE)%>%
...
report%>%
  add_slide()%>%
  ph_with(external_img(here::here("results", params$year, params$month, "westend", "westend_use.jpeg"), width = 9.5, height = 7.5), location = ph_location_type(type = "title"), use_loc_size = FALSE)%>%
  ph_with("West End", 
               location = ph_location_type(
                 type = "title") )-> report
}
...
report%>%
  add_slide()%>%
  ph_with(external_img(here::here("results", params$year, params$month, "vstprk", "vstprk_use.jpeg"), width = 5.31, height = 7.5), location = ph_location_type(type = "title"), use_loc_size = FALSE)%>%
...
report%>%
  add_slide()%>%
  ph_with(external_img(here::here("results", params$year, params$month, "academy", "ac_use.jpeg"), width = 5.21, height = 7.5), location = ph_location_type(type = "title"), use_loc_size = FALSE)%>%
  ph_with("Academy", 
               location = ph_location_type(
                 type = "title") )-> report
}
...
report%>%
  add_slide()%>%
  ph_with(external_img(here::here("results", params$year, params$month, "ftnprk", "ftnprk_use.jpeg"), width = 4.06, height = 7.5), location = ph_location_type(type = "title"), use_loc_size = FALSE)%>%
...
report%>%
  add_slide()%>%
  ph_with(external_img(here::here("results", params$year, params$month, "lewis", "lewis_use.jpeg"), width = 6.18, height = 7.5), location = ph_location_type(type = "title"), use_loc_size = FALSE)%>%
  ph_with("Lewis Place", 
               location = ph_location_type(
                 type = "title") )-> report
}
...
report%>%
  add_slide()%>%
  ph_with(external_img(here::here("results", params$year, params$month, "vandy", "vandy_use.jpeg"), width = 8.27, height = 7.5), location = ph_location_type(type = "title"), use_loc_size = FALSE)%>%
  ph_with("Vandeventer", 
               location = ph_location_type(
                 type = "title") )-> report
}
