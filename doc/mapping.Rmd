...
df <- read_csv(here("data", params$year, params$month,  "clean_data.csv"))

avg <- read_csv(here("data", params$year, params$month,  "mean_data.csv"))
...
sprint_4 <- sprintf("%s building permits in Forest Park Southeast in %s %s",
